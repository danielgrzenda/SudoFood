...
sims_rn = gensim.similarities.Similarity.\
 load('MachineLearning/picklefiles/similarity_recipe_name1', mmap=None)
sims = gensim.similarities.Similarity.\
 load('MachineLearning/picklefiles/similarity', mmap=None)
...
ENGLISH_STOP_WORDS = frozenset([
 ...
 "\xc2\xbc", "\xc2\xbd", "cup", "cups", "ounces", "ounce", "teaspoon",
 "tablespoon", "tablespoons", "teaspoons", " extract", 'tbsp',
 'teaspoon', 'lb', 'pound', 'tsp', 'cup', 'gms', 'powder', 'medium',
 'g', 'stick', 'whole', 'tablespoon', 'quarts', 'ounce', 'ml', 'can',
